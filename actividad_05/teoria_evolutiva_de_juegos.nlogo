...
to init_jugadores
  ...
  if length distribucion_inicial != length matriz_pagos [
   user-message "El número de elemento de num_jugadores_por_estrategia debe ser igual al número de filas de la matriz de pagos"
  ]
...
to actualizar_grafica
  ...
  let frec_estrategias map [ n -> (count turtles with [estrategia = n]) / (count turtles) ] nums_estrategias
